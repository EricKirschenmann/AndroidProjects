...
public class DataDBSchema {
    ...
    public static final class ShoesTable
    {
    ...
    public static final class OutdoorTable
    {
    ...
    public static final class SportsTable
    {
    ...
    public static final class IllnessesTable
    {
